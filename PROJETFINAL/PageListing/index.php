<?php include 'verification.php';
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-3 align-self-middle border rounded-left rounded-right-75 bg-success">
                <a  class="nav-link myDiv" name="quizz" data-idquizz="1" >GEOGRAPHIE</a>
            </div>
            
        </div><br>
        <div class="row">
            <div class="col-3 align-self-center border rounded-left rounded-right-75 bg-primary">
        ...
        <div class="row">
            <div class="col-3 align-self-end border rounded-left rounded-right-75 bg-info">
    ...
    <form method="post" action="../PageTransiQuizzeur/index.php" >
        <button type="submit"  class="btn btn-dark" name='CreaQuizz' value="Créer un quizz">Créer un quizz</button>
    </form>
</div>
