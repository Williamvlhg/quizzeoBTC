...
--
-- Host: localhost:8889
-- Generation Time: Jun 30, 2023 at 08:48 AM
...
(9, 'Le rugby est originaire de quel pays ?', 1, '2023-06-20', 1),
...
CREATE TABLE `Role` (
  ...
  `IntituléDuRole` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `Role` (`IDRole`, `IntituléDuRole`) VALUES
(3, 'Administrateur'),
(2, 'Quizzeur'),
(1, 'Utilisateur');
...
INSERT INTO `Score` (`IDQuizz`, `IDJoueur`, `Score`) VALUES
(1, 1, 20);
...
(19, 'zakileplusbeau', 'zaki@zaki', '$2y$10$a09WseIbcte3S/AN/wnleeqZRjJgYbjZn.quLEf1Ih6GK1g58UBKC', 2),
(22, 'zqsd', 'zqsd@zqsd', '$2y$10$joNaDgbYaSnJBP1JJpOPZOtAKxiSHUbwY0A17PsVlzknb5lTmyS8q', 1),
(23, 'tttt', 'tttt@tttt', '$2y$10$SP0d46nAJuKvciKJJHBAYO./Ut0hZCxoJPxXcmLyoowQpJ.HIC/O6', 2),
(24, 'test11', 'test11@test11', '$2y$10$de3.CmsfY32KFyWYVOv7xOFuXRXDfbHrnTuZgYgKSm1JSkrmtnUBq', 2);
...
ALTER TABLE `Role`
  ...
  ADD UNIQUE KEY `IntituléDuRole` (`IntituléDuRole`);
...
--
ALTER TABLE `Choix`
  MODIFY `IdC` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=322;

--
-- AUTO_INCREMENT for table `Question`
--
ALTER TABLE `Question`
  MODIFY `IdQt` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;
...
--
ALTER TABLE `Score`
  ADD CONSTRAINT `IdUser` FOREIGN KEY (`IDJoueur`) REFERENCES `User` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `iddqz` FOREIGN KEY (`IDQuizz`) REFERENCES `Quizz` (`IdQz`);

--
-- Constraints for table `User`
--
ALTER TABLE `User`
  ADD CONSTRAINT `IDRole` FOREIGN KEY (`Role`) REFERENCES `Role` (`IDRole`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
